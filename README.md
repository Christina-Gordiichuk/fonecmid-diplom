...
Для специалистов заказчика: какие действия выполнить в уже рабочей базе «Управление IT-фирмой», чтобы включить заявки, акты, Telegram и управленческую зарплату.

Полный текст: [fonecmid-diplom/readme.md](fonecmid-diplom/readme.md).
