...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если НастройкиФормы.ИмяФормы = "Документ.ВКМ_ОбслуживаниеКлиента.ФормаСписка" Тогда
		Команда = Команды.Добавить();
		Команда.Вид = "Отчеты";
		Команда.Идентификатор = "ВКМ_ОткрытьАнализОбслуживания";
		Команда.Представление = НСтр("ru = 'Анализ обслуживания клиентов'");
		Команда.Порядок = 15;
		Команда.Назначение = "ДляСписка";
		Команда.Менеджер = Метаданные.Документы.ВКМ_ОбслуживаниеКлиента.ПолноеИмя();
		Команда.ИмяФормы = "Отчет.ВКМ_АнализОбслуживанияКлиентов.Форма.ФормаОтчета";
	...
	Если НастройкиФормы.ИмяФормы <> "Документ.ЗаказПокупателя.ФормаСписка" Тогда
		Возврат;
	КонецЕсли;

	Команда = Команды.Добавить();
	Команда.Вид = "ЗаполнениеОбъектов";
	Команда.Идентификатор = "ВКМ_МассовоСоздатьАкты";
	Команда.Представление = НСтр("ru = 'Массово создать акты'");
	Команда.Порядок = 20;
	Команда.Назначение = "ДляСписка";
	Команда.Менеджер = Метаданные.Документы.ЗаказПокупателя.ПолноеИмя();
	Команда.Обработчик = "ВКМ_МассовоСоздатьАкты";
	Команда.РежимЗаписи = "НеЗаписывать";
	...
	Команда = Команды.Добавить();
	Команда.Вид = "ЗаполнениеОбъектов";
	Команда.Идентификатор = "ВКМ_ОткрытьМассовоеСозданиеАктов";
	Команда.Представление = НСтр("ru = 'Открыть обработку массового создания актов'");
	Команда.Порядок = 21;
	Команда.Назначение = "ДляСписка";
	Команда.Менеджер = Метаданные.Документы.ЗаказПокупателя.ПолноеИмя();
	Команда.ИмяФормы = "Обработка.ВКМ_МассовоеСозданиеАктов.Форма.Форма";
	Команда.РежимЗаписи = "НеЗаписывать";
	Команда.МножественныйВыбор = Истина;
	Команда.ИзменяетВыбранныеОбъекты = Ложь;
	// ВКМ_Изменение_Конец
